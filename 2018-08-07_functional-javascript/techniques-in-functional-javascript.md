...
- Function composition enables us to easily connect a number of functions together to build more complex functions. <!-- .element: class="fragment" data-fragment-index="1" -->
...
- We can decompose switchCase into multiple reusable methods. <!-- .element: class="fragment" data-fragment-index="2" -->
